...
- [ ] **⏰ GA4 Internal-Traffic-Filter aktivieren** – nach der IP-Korrektur (2026-09-14) erst ein paar Tage aktiv auf der Seite browsen, dann via Dimension "Name des Testdatenfilters" in Berichten prüfen, ob Traffic jetzt korrekt als "internal" markiert wird. Erst danach Filter in Verwaltung → Datenfilter von "Test" auf "Aktiv" setzen. IP ist vermutlich weiterhin dynamisch – bei erneutem Ausfall Regel unter Datenstream → Google-Tag → Internen Traffic definieren erneut aktualisieren
